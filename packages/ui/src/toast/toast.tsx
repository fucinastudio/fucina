...
const ToastProvider = ({ ...props }: ToasterProps) => {
  ...
  return (
    <Sonner
      ...
      toastOptions={{
        classNames: {
          toast: "bg-elevated !border border-default !text !text-md !font-medium !gap-2 !rounded-lg !shadow-lg",
          description: "!font-regular [data-type=error]:!text-danger-strong [data-type=warning]:!text-warning-strong",
          actionButton: "!bg-neutral !text-inverse !text-sm !font-medium !flex !h-8 !items-center !px-2" ,
          closeButton: "!bg-elevated !text-description !border-default hover:!text hover:!border-item hover:!bg-item-active",
