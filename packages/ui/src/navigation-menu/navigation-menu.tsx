...
const navigationMenuVariants = tv({
  base: ["group flex list-none gap-1 items-center justify-start"],
  variants: {
    orientation: {
      horizontal: ["flex-row"],
      vertical: ["flex-col"],
...
>(({ className, children, size = "default", ...props }, ref) => (
  <NavigationMenuPrimitive.Link
    ...
    className={cn(
      ...
      "text-description group flex w-max cursor-pointer items-center justify-center gap-1 rounded font-medium transition-colors [&>svg]:size-4",
