...
>(({ className, hint, shortcut, children, ...props }, forwardedRef) => (
  <DropdownMenuPrimitives.RadioItem
    ...
    className={cn(
      // base
      "group/DropdownMenuRadioItem data-[state=checked]:text-brand relative flex h-9 cursor-pointer select-none items-center gap-2 rounded-sm py-1 pl-8 pr-1.5 outline-none transition-colors [&>svg]:size-4",
      // disabled
      "data-[disabled]:text-disabled data-[disabled]:pointer-events-none data-[disabled]:hover:bg-none",
      // focus
      "focus-visible:bg-item-active",
