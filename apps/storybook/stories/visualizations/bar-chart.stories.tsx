...
import { BarChart, BarChartTooltipProps } from "@fucina/visualizations";
...
const meta: Meta<typeof BarChart> = {
  ...
  parameters: {
    docs: {
      description: {
        component: "Graph with bars to compare values across categories.",
      },
    },
  },
};
...
export const Default: Story = {
  render: () => (
    <BarChart data-testid="bar-chart" data={chartdata} index="date" categories={["SolarCells", "Glass"]} />
  ),
};
...
function WithTooltipCallbackExample() {
  const [callback, setCallBack] = React.useState<BarChartTooltipProps | null>(null);
...
export const CustomTooltip: Story = {
  args: {
    categories: ["SolarCells"],
    yAxisWidth: 65,
    customTooltip: (props: BarChartTooltipProps) => {
