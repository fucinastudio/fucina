...
import { NavigationMenu, NavigationMenuLink, NavigationMenuList, NavigationMenuItem } from "@fucina/ui";
...
<Cards className="mt-8">
  <Card
    title="🤖 Storybook"
    href="https://fucina-storybook.vercel.app/?path=/docs/components-navigationmenu--documentation"
  />
  <Card
    title="🪄 Figma"
    href="https://www.figma.com/design/Jfto7FUoU7mSpnv9uESD60/%F0%9F%94%A5-Fucina---Design-System?node-id=8295-15561&t=SkIduRAaGEKfas8z-1"
  />
  <Card
    title="🐝 API Reference"
