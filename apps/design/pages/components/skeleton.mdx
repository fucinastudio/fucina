...
<Tabs items={['Preview', 'Code']}>
  ...
  <Tabs.Tab>
    ...
    import { Skeleton } from "@fucina/ui/components/skeleton"
...
<Tabs items={['Preview', 'Code']}>
  ...
  <Tabs.Tab>
    ...
    import { Skeleton } from "@fucina/ui/components/skeleton"
    import { Card, CardContent } from "@fucina/ui/components/card"
...
<Cards className="mt-8">
  ...
  <Card
    title="🪄 Figma"
    href="https://www.figma.com/design/Jfto7FUoU7mSpnv9uESD60/%F0%9F%9F%A0-feely---design-system?node-id=540-8878&t=nua4UmG9Iu1hfUAm-1"
  />
</Cards>
