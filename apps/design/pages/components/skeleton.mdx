...
<Tabs.Tab>
```js copy /shape="circle"/ filename="skeleton.tsx"
import { Skeleton } from "@fucina/ui"
...
<Tabs.Tab>
```js copy /shape="line"/ filename="skeleton.tsx"
import { Skeleton } from "@fucina/ui"
...
<Tabs.Tab>
```js copy /Card/ filename="skeleton.tsx"
...
<Cards className="mt-8">
  <Card
    title="🤖 Storybook"
    href="https://fucina-storybook.vercel.app/?path=/docs/components-skeleton--documentation"
  />
  <Card
    title="🪄 Figma"
    href="https://www.figma.com/design/Jfto7FUoU7mSpnv9uESD60/%F0%9F%94%A5-Fucina---Design-System?node-id=639-30188&t=BERFxjM8vy494uCE-1"
  />
</Cards>
