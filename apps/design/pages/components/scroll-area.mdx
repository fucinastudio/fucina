...
import { ScrollArea, Separator } from "@fucina/ui";
  ...
  return (
    <ScrollArea className="h-72 w-48 rounded border border-default">
      <div className="p-4">
        ...
        {tags.map((tag) => (
          <>
            <div key={tag} className="text-md">{tag}</div>
...
<Tabs.Tab>
```js copy /orientation="horizontal"/ filename="scroll-area.tsx"
import * as React from "react"
import Image from "next/image"

import { ScrollArea, ScrollBar } from "@fucina/ui";
...
<Cards className="mt-8">
  <Card
    title="🤖 Storybook"
    href="https://fucina-storybook.vercel.app/?path=/docs/components-scrollarea--documentation"
  />
  <Card
    title="🪄 Figma"
    href="https://www.figma.com/design/Jfto7FUoU7mSpnv9uESD60/%F0%9F%94%A5-Fucina---Design-System?node-id=639-26055&t=BERFxjM8vy494uCE-1"
  />
  <Card
    title="🐝 API Reference"
