...
<Tabs items={['Preview', 'Code']}>
  ...
  <Tabs.Tab>
    ...
    import { ScrollArea } from "@fucina/ui/components/scroll-area"
    import { Separator } from "@fucina/ui/components/separator"
...
<Tabs items={['Preview', 'Code']}>
  ...
  <Tabs.Tab>
    ...
    import { ScrollArea, ScrollBar } from "@fucina/ui/components/scroll-area"
...
<Cards className="mt-8">
  ...
  <Card
    title="🪄 Figma"
    href="https://www.figma.com/design/Jfto7FUoU7mSpnv9uESD60/%F0%9F%9F%A0-feely---design-system?node-id=540-8874&t=nua4UmG9Iu1hfUAm-1"
  />
  <Card
    title="🐝 API Reference"
