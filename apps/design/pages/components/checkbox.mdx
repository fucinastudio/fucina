...
import { Checkbox } from "@fucina/ui"
...
<Tabs.Tab>
```js copy {5} /checked="indeterminate"/ filename="checkbox.tsx"
import { Checkbox } from "@fucina/ui"
...
<Tabs.Tab>
```js copy {7} /Label/ filename="checkbox.tsx"
import { Checkbox, Label } from "@fucina/ui"
...
import {
  ...
  FormMessage,
  toast,
} from "@fucina/ui/components/button";
...
<Cards className="mt-8">
  <Card
    title="🤖 Storybook"
    href="https://fucina-storybook.vercel.app/?path=/docs/components-checkbox--documentation"
  />
  <Card
    title="🪄 Figma"
    href="https://www.figma.com/design/Jfto7FUoU7mSpnv9uESD60/%F0%9F%94%A5-Fucina---Design-System?node-id=639-12273&t=djNmFHh9aJkVZtk7-1"
  />
  <Card
    title="🐝 API Reference"
