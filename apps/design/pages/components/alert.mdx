...
<Tabs.Tab>
```js copy {6} /variant="default"/ filename="alert.tsx"
import { Alert } from "@fucina/ui"
import { Megaphone } from "lucide-react"
...
<Tabs.Tab>
```js copy {6} /variant="brand"/ filename="alert.tsx"
import { Alert } from "@fucina/ui"
...
<Tabs.Tab>
```js copy {6} /variant="danger"/ filename="alert.tsx"
import { Alert } from "@fucina/ui"
...
<Tabs.Tab>
```js copy {6} /variant="warning"/ filename="alert.tsx"
import { Alert } from "@fucina/ui"
...
<Cards className="mt-8">
  <Card
    title="🤖 Storybook"
    href="https://fucina-storybook.vercel.app/?path=/docs/components-alert--documentation"
  />
  <Card
    title="🪄 Figma"
    href="https://www.figma.com/design/Jfto7FUoU7mSpnv9uESD60/%F0%9F%94%A5-Fucina---Design-System?node-id=613-22656&t=djNmFHh9aJkVZtk7-1"
  />
</Cards>
