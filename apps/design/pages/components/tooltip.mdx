...
<Tabs items={['Preview', 'Code']}>
  ...
  <Tabs.Tab>
    ...
    import { Tooltip, TooltipContent, TooltipProvider, TooltipTrigger } from "@fucina/ui/components/tooltip"
    import { Button } from "@fucina/ui/components/button"
    import { FilePlus } from "@fucina/ui/components/icon"
...
<Tabs items={['Preview', 'Code']}>
  ...
  <Tabs.Tab>
    ```js copy filename="tooltip.tsx"
    import { Tooltip } from "@fucina/ui/components/tooltip"
    import { Button } from "@fucina/ui/components/button"
    import { FilePlus } from "@fucina/ui/components/icon"
...
<Cards className="mt-8">
  <Card
    title="🤖 Storybook"
    href="https://fucina-storybook.vercel.app/?path=/docs/components-tooltip--documentation"
  />
  <Card
    title="🪄 Figma"
    href="https://www.figma.com/design/Jfto7FUoU7mSpnv9uESD60/%F0%9F%9F%A0-feely---design-system?node-id=540-8886&t=nua4UmG9Iu1hfUAm-1"
  />
  <Card
    title="🐝 API Reference"
