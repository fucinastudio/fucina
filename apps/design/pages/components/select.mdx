...
<Cards className="mt-8">
  ...
  <Card
    title="🪄 Figma"
    href="https://www.figma.com/design/Jfto7FUoU7mSpnv9uESD60/%F0%9F%94%A5-Fucina---Design-System?node-id=639-29636&t=BERFxjM8vy494uCE-1"
  />
  <Card
    title="🐝 API Reference"
...
Use our [Label](/components/label) component in order to offer a visual and accessible label for the select.

```js copy /Label/
import { Select, Label } from "@fucina/ui";
