...
<Tabs items={['Preview', 'Code']}>
  ...
  import { Select, SelectContent, SelectGroup, SelectItem, SelectLabel, SelectTrigger, SelectValue } from "@fucina/ui/components/select"
...
import { Form, FormControl, FormDescription, FormField, FormItem, FormLabel, FormMessage } from "@fucina/ui/components/form"
import { Select, SelectContent, SelectItem, SelectTrigger, SelectValue } from "@fucina/ui/components/select"
import { toast } from "@fucina/ui/components/toast/use-toast"
...
<Cards className="mt-8">
  <Card
    title="🤖 Storybook"
    href="https://fucina-storybook.vercel.app/?path=/docs/components-select--documentation"
  />
  <Card
    title="🪄 Figma"
    href="https://www.figma.com/design/Jfto7FUoU7mSpnv9uESD60/%F0%9F%9F%A0-feely---design-system?node-id=540-8875&t=nua4UmG9Iu1hfUAm-1"
  />
  <Card
    title="🐝 API Reference"
...
```js copy {6} /Label/
import { Select } from "@fucina/ui/components/select";
import { Label } from "@fucina/ui/components/label";
