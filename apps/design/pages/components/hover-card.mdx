...
<Tabs items={['Preview', 'Code']}>
  ...
  <Tabs.Tab>
    ...
    import { Avatar, AvatarFallback, AvatarImage } from "@fucina/ui/components/avatar"
    import { Button } from "@fucina/ui/components/button"
    import { HoverCard, HoverCardContent, HoverCardTrigger } from "@fucina/ui/components/hover-card"
...
<Cards className="mt-8">
  <Card
    title="🤖 Storybook"
    href="https://fucina-storybook.vercel.app/?path=/docs/components-hovercard--documentation"
  />
  <Card
    title="🪄 Figma"
    href="https://www.figma.com/design/Jfto7FUoU7mSpnv9uESD60/%F0%9F%9F%A0-feely---design-system?node-id=540-8866&t=nua4UmG9Iu1hfUAm-1"
  />
  <Card
    title="🐝 API Reference"
