...
<Tabs.Tab>
```js copy /single/ filename="accordion.tsx"
import { Accordion, AccordionContent, AccordionItem, AccordionTrigger } from "@fucina/ui"
...
<Tabs.Tab>
```js copy /multiple/ filename="accordion.tsx"
import { Accordion, AccordionContent, AccordionItem, AccordionTrigger } from "@fucina/ui"
...
<Tabs.Tab>
```js copy /collapsible/ filename="accordion.tsx"
import { Accordion, AccordionContent, AccordionItem, AccordionTrigger } from "@fucina/ui"
...
<Tabs.Tab>
```js copy /defaultValue/ filename="accordion.tsx"
import { Accordion, AccordionContent, AccordionItem, AccordionTrigger } from "@fucina/ui"
...
<Cards className="mt-8">
  <Card
    title="🤖 Storybook"
    href="https://fucina-storybook.vercel.app/?path=/docs/components-accordion--documentation"
  />
  <Card
    title="🪄 Figma"
    href="https://www.figma.com/design/Jfto7FUoU7mSpnv9uESD60/%F0%9F%94%A5-Fucina---Design-System?node-id=612-22584&t=djNmFHh9aJkVZtk7-1"
  />
  <Card
    title="🐝 API Reference"
