...
<Tabs items={['Preview', 'Code']}>
  ...
  <Tabs.Tab>
    ...
    import { Card, CardContent, CardDescription, CardFooter, CardHeader, CardTitle } from "@fucina/ui/components/card"
    import { Input } from "@fucina/ui/components/input"
    import { Label } from "@fucina/ui/components/label"
    import { Tabs, TabsContent, TabsList, TabsTrigger } from "@fucina/ui/components/tabs"
...
<Cards className="mt-8">
  <Card
    title="🤖 Storybook"
    href="https://fucina-storybook.vercel.app/?path=/docs/components-tabs--documentation"
  />
  <Card
    title="🪄 Figma"
    href="https://www.figma.com/design/Jfto7FUoU7mSpnv9uESD60/%F0%9F%9F%A0-feely---design-system?node-id=540-8882&t=nua4UmG9Iu1hfUAm-1"
  />
  <Card
    title="🐝 API Reference"
