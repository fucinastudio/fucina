...
<Tabs.Tab>
```js copy {7,40,77} /CommandDialog/ filename="command.tsx"
"use client"
...
<Cards className="mt-8">
  <Card
    title="🤖 Storybook"
    href="https://fucina-storybook.vercel.app/?path=/docs/components-command--documentation"
  />
  <Card
    title="🪄 Figma"
    href="https://www.figma.com/design/Jfto7FUoU7mSpnv9uESD60/%F0%9F%94%A5-Fucina---Design-System?node-id=639-14013&t=djNmFHh9aJkVZtk7-1"
  />
