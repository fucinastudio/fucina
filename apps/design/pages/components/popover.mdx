...
import { Popover, PopoverContent, PopoverTrigger, Label, Input, Button } from "@fucina/ui"
...
<Cards className="mt-8">
  ...
  <Card
    title="🪄 Figma"
    href="https://www.figma.com/design/Jfto7FUoU7mSpnv9uESD60/%F0%9F%94%A5-Fucina---Design-System?node-id=639-25610&t=BERFxjM8vy494uCE-1"
  />
  <Card
    title="🐝 API Reference"
