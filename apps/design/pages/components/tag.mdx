...
<Tabs.Tab>
```js copy /variant="purple"/ filename="tag.tsx"
import { Tag } from "@fucina/ui";
import { TagIcon } from 'lucide-react';

export function TagDemo() {
  return (
    <Tag variant="purple"><TagIcon />Markup</Tag>
  );
}
```
</Tabs.Tab>
...
<Tabs.Tab>
```js copy /variant="pink"/ filename="tag.tsx"
import { Tag } from "@fucina/ui";
import { TagIcon } from 'lucide-react';

export function TagDemo() {
  return (
    <Tag variant="pink"><TagIcon />Markup</Tag>
  );
}
```
</Tabs.Tab>
...
<Cards className="mt-8">
  ...
  <Card
    title="🪄 Figma"
    href="https://www.figma.com/design/Jfto7FUoU7mSpnv9uESD60/%F0%9F%94%A5-Fucina---Design-System?node-id=639-31205&t=SkIduRAaGEKfas8z-1"
  />
</Cards>
