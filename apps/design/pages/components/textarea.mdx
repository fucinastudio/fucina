...
import { Textarea } from "@fucina/ui"
...
<Tabs.Tab>
```js copy filename="textarea.tsx"
import { Textarea, Label } from "@fucina/ui"
...
<Cards className="mt-8">
  ...
  <Card
    title="🪄 Figma"
    href="https://www.figma.com/design/Jfto7FUoU7mSpnv9uESD60/%F0%9F%94%A5-Fucina---Design-System?node-id=639-31407&t=SkIduRAaGEKfas8z-1"
  />
</Cards>
