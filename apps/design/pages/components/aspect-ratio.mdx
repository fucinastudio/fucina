...
<Tabs.Tab>
```js copy /ratio/ filename="aspect-ratio.tsx"
import Image from "next/image"
import { AspectRatio } from "@fucina/ui"
...
<Cards className="mt-8">
  <Card
    title="🤖 Storybook"
    href="https://fucina-storybook.vercel.app/?path=/docs/components-aspectratio--documentation"
  />
  <Card
    title="🪄 Figma"
    href="https://www.figma.com/design/Jfto7FUoU7mSpnv9uESD60/%F0%9F%94%A5-Fucina---Design-System?node-id=639-4766&t=djNmFHh9aJkVZtk7-1"
  />
  <Card
    title="🐝 API Reference"
