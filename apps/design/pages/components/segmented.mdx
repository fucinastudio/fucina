...
<Tabs.Tab>
```js copy /defaultValue/ filename="segmented.tsx"
import { Segmented, SegmentedContent, SegmentedList, SegmentedTrigger } from "@fucina/ui";
...
<Tabs.Tab>
```js copy /disabled/ filename="segmented.tsx"
import { Segmented, SegmentedContent, SegmentedList, SegmentedTrigger } from "@fucina/ui";
...
<Cards className="mt-8">
  ...
  <Card
    title="🪄 Figma"
    href="https://www.figma.com/design/Jfto7FUoU7mSpnv9uESD60/%F0%9F%94%A5-Fucina---Design-System?node-id=763-4078&t=BERFxjM8vy494uCE-1"
  />
  <Card
    title="🐝 API Reference"
