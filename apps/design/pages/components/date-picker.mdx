...
<Tabs items={['Preview', 'Code']}>
  ...
  <Tabs.Tab>
    ...
    import { Calendar as CalendarIcon } from "@fucina/ui/components/icon"
    import { Button } from "@fucina/ui/components/button"
    import { Calendar } from "@fucina/ui/components/calendar"
    import { Popover, PopoverContent, PopoverTrigger } from "@fucina/ui/components/popover"
...
<Cards className="mt-8">
  <Card
    title="🤖 Storybook"
    href="https://fucina-storybook.vercel.app/?path=/docs/components-date-picker--documentation"
  />
  <Card
    title="🪄 Figma"
    href="https://www.figma.com/design/Jfto7FUoU7mSpnv9uESD60/%F0%9F%9F%A0-feely---design-system?node-id=540-8862&t=nua4UmG9Iu1hfUAm-1"
  />
</Cards>
