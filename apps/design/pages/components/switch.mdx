...
<Tabs items={['Preview', 'Code']}>
  ...
  <Tabs.Tab>
    ...
    import { Switch } from "@fucina/ui/components/switch"
...
<Tabs items={['Preview', 'Code']}>
  ...
  <Tabs.Tab>
    ...
    import { Form, FormControl, FormDescription, FormField, FormItem, FormLabel } from '@fucina/ui/components/form';
    import { Switch } from '@fucina/ui/components/switch';
...
<Cards className="mt-8">
  <Card
    title="🤖 Storybook"
    href="https://fucina-storybook.vercel.app/?path=/docs/components-switch--documentation"
  />
  <Card
    title="🪄 Figma"
    href="https://www.figma.com/design/Jfto7FUoU7mSpnv9uESD60/%F0%9F%9F%A0-feely---design-system?node-id=540-8880&t=nua4UmG9Iu1hfUAm-1"
  />
  <Card
    title="🐝 API Reference"
