...
<Tabs items={['Preview', 'Code']}>
  ...
  <Tabs.Tab>
    ...
    import { Dialog, DialogContent, DialogDescription, DialogFooter, DialogHeader, DialogTitle, DialogTrigger } from "@fucina/ui/components/dialog"
...
<Tabs items={['Preview', 'Code']}>
  ...
  <Tabs.Tab>
    ...
    import { Button } from "@fucina/ui/components/button"
    import { Dialog, DialogContent, DialogDescription, DialogFooter, DialogHeader, DialogTitle, DialogTrigger, DialogClose } from "@fucina/ui/components/dialog"
    import { Input } from "@fucina/ui/components/input"
    import { Label } from "@fucina/ui/components/label"
...
<Cards className="mt-8">
  <Card
    title="🤖 Storybook"
    href="https://fucina-storybook.vercel.app/?path=/docs/components-dialog--documentation"
  />
  <Card
    title="🪄 Figma"
    href="https://www.figma.com/design/Jfto7FUoU7mSpnv9uESD60/%F0%9F%9F%A0-feely---design-system?node-id=540-8863&t=nua4UmG9Iu1hfUAm-1"
  />
  <Card
    title="🐝 API Reference"
