...
<Tabs.Tab>
```js copy /variant="primary"/ filename="button.tsx"
import { Button } from "@fucina/ui"
...
<Tabs.Tab>
```js copy /variant="secondary"/ filename="button.tsx"
import { Button } from "@fucina/ui"
...
<Tabs.Tab>
```js copy /variant="text"/ filename="button.tsx"
import { Button } from "@fucina/ui"
...
<Tabs.Tab>
```js copy /variant="link"/ filename="button.tsx"
import { Button } from "@fucina/ui"
...
<Tabs.Tab>
```js copy /variant="danger"/ filename="button.tsx"
import { Button } from "@fucina/ui"
...
<Tabs.Tab>
```js copy /Download/ filename="button.tsx"
import { Button } from "@fucina/ui"
...
<Tabs.Tab>
```js copy /icon={true}/ filename="button.tsx"
import { Button } from "@fucina/ui"
...
<Tabs.Tab>
```js copy /size="small"/ filename="button.tsx"
import { Button } from "@fucina/ui"

export function ButtonDemo() {
    return <Button size="small" variant="primary">Small</Button>
}
```
</Tabs.Tab>
</Tabs>
...
<Tabs.Tab>
```js copy /asChild/ filename="button.tsx"
import { Button } from "@fucina/ui"
...
<Cards className="mt-8">
  <Card
    title="🤖 Storybook"
    href="https://fucina-storybook.vercel.app/?path=/docs/components-button--documentation"
  />
  <Card
    title="🪄 Figma"
    href="https://www.figma.com/design/Jfto7FUoU7mSpnv9uESD60/%F0%9F%94%A5-Fucina---Design-System?node-id=639-9194&t=djNmFHh9aJkVZtk7-1"
  />
</Cards>
