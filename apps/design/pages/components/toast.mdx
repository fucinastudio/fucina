...
<Tabs.Tab>
```js copy /description/ filename="toast.tsx"
"use client"
import { Button, toast } from "@fucina/ui"
...
<Tabs.Tab>
```js copy /title/ filename="toast.tsx"
"use client"
import { Button, toast } from "@fucina/ui"
...
<Tabs.Tab>
```js copy /action/ filename="toast.tsx"
"use client"
import { Button, toast } from "@fucina/ui"
...
<Tabs.Tab>
```js copy /status: "danger"/ filename="toast.tsx"
"use client"
import { Button, useToast } from "@fucina/ui"
...
<Tabs.Tab>
```js copy /status: "warning"/ filename="toast.tsx"
"use client"
import { Button, useToast } from "@fucina/ui"
...
<Cards className="mt-8">
  ...
  <Card
    title="🪄 Figma"
    href="https://www.figma.com/design/Jfto7FUoU7mSpnv9uESD60/%F0%9F%94%A5-Fucina---Design-System?node-id=639-31590&t=SkIduRAaGEKfas8z-1"
  />
  <Card
    title="🐝 API Reference"
