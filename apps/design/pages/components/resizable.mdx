...
<Tabs.Tab>
```js copy /direction="vertical"/ filename="resizable.tsx"
import { ResizableHandle, ResizablePanel, ResizablePanelGroup } from "@fucina/ui"
...
<Tabs.Tab>
```js copy /withHandle/ filename="resizable.tsx"
import { ResizableHandle, ResizablePanel, ResizablePanelGroup } from "@fucina/ui"
...
<Cards className="mt-8">
  ...
  <Card
    title="🪄 Figma"
    href="https://www.figma.com/design/Jfto7FUoU7mSpnv9uESD60/%F0%9F%94%A5-Fucina---Design-System?node-id=2322-3533&t=BERFxjM8vy494uCE-1"
  />
  <Card
    title="🐝 API Reference"
