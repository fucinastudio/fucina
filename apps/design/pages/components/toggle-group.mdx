...
<Tabs items={['Preview', 'Code']}>
  ...
  ```js copy filename="toggle-group.tsx"
    import { Bold, Italic, Underline } from "@fucina/ui/components/icon"
    import { ToggleGroup, ToggleGroupItem } from "@fucina/ui/components/toggle-group"
...
<Cards className="mt-8">
  <Card
    title="🤖 Storybook"
    href="https://fucina-storybook.vercel.app/?path=/docs/components-toggle-group--documentation"
  />
  <Card
    title="🪄 Figma"
    href="https://www.figma.com/design/Jfto7FUoU7mSpnv9uESD60/%F0%9F%9F%A0-feely---design-system?node-id=1063-304&t=nua4UmG9Iu1hfUAm-1"
  />
  <Card
    title="🐝 API Reference"
