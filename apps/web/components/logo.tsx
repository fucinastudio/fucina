      ...
      <Link href="/" className={cn("rounded", focusRing)}>
        <div className="flex items-center justify-center gap-2">
          <svg width="22" height="28" viewBox="0 0 22 28" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M19.6692 28H1.96712L0 22.9604H21.6364L19.6692 28Z" fill="url(#paint0_linear_178_267)" />
            <path
          ...
          <span className="font-logo pt-0.5 text-2xl font-medium uppercase">Fucina</span>
        </div>
      </Link>
    </div>
  );
